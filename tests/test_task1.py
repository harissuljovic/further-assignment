...
def test_schedule_a_tour(page, test_data):
    ...
    chat_page.navigate()
    chat_page.wait_for_initial_message()
    ...
    chat_page.click_send_msg_btn()
    chat_page.verify_invalid_email_error_message("Please use a valid email address")
    ...
    chat_page.click_send_msg_btn()
    chat_page.verify_invalid_email_error_message("Sorry but that is an invalid phone number. Please check it is 10 digits long and does not contain letters or symbols.")
